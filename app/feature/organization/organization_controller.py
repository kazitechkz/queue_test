...
from app.core.auth_core import check_legal_client, check_admin, check_admin_and_employee
...
class OrganizationController:
    ...
    async def get_by_bin(
        ...
        existed_by_bin = await repo.get_filtered({"bin": bin}, options=[selectinload(OrganizationModel.owner),
