...
class OrganizationFilter(BaseFilter):
    def __init__(self,
                 ...
                 owner_id: Optional[int] = Query(default=None, gt=0, description="Введите владельца компании"),
                 type_id: Optional[int] = Query(default=None, gt=0, description="Введите тип организации")):
