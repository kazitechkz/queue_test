    ...
    async def request_to_sap(
        ...
        try:
            ...
            if (order.organization_id is not None):
                data = await sapService.request_to_sap_legal(werks=sap_request.werks, matnr=sap_request.matnr,
                ...
                sap_request_dto.pdf = base64.b64decode(
                    pdf_base64) if pdf_base64 else None  # Декодирование Base64 в байты
