...
from app.feature.workshop.dtos.workshop_dto import WorkshopCDTO, WorkshopRDTO
...
class WorkshopController:
    ...
    def _add_routes(self) -> None:
        ...
        self.router.delete(
            "/delete/{id}", summary="Удалить цех по id", description="Удаление цеха по id"
        )(self.delete)
    ...
    async def create(
        ...
        if existed is not None:
            raise AppExceptionResponse.bad_request(
                message="Цех с таким sap_id уже существует"
            )
