...
from app.feature.region.dtos.region_dto import RegionCDTO, RegionRDTO
...
class RegionController:
    ...
    async def create(
        ...
        if existed_organization_type is not None:
            raise AppExceptionResponse.bad_request(
                message="Такое значение для региона уже существует"
            )
    ...
    async def update(
        ...
        if (
            ...
            and existed_organization_type.id != Region.id
        ):
            raise AppExceptionResponse.bad_request(
                message="Такое значение для региона уже существует"
            )
