...
from app.feature.organization_type.dtos.organization_type_dto import (
...
class OrganizationTypeController:
    ...
    async def create(
        ...
        if existed_organization_type is not None:
            raise AppExceptionResponse.bad_request(
                message="Такое значение для типа организации уже существует"
            )
    ...
    async def update(
        ...
        if (
            ...
            and existed_organization_type.id != OrganizationType.id
        ):
            raise AppExceptionResponse.bad_request(
                message="Такое значение для типа организации уже существует"
            )
