...
class KaspiPaymentPayParam:
    def __init__(self,
                 ...
                 txn_date: str = Query(max_length=50, description="ГГГГММДДЧЧММСС",examples="20240917100102"),
                 account: str = Query(max_length=20, description="Номер заказа для kaspi"),
                 sum: Optional[str] = Query(default=None, description="Сумма к зачислению в формате '500.00'", example="500.00")
                 ):
