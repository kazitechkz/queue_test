...
class OrganizationModel(Base):
    ...
    owner_id:Mapped[int] = mapped_column(ForeignKey(AppTableNames.UserTableName + ".id",ondelete="set null", onupdate="set null"),nullable=True)
    type_id:Mapped[int] = mapped_column(ForeignKey(AppTableNames.OrganizationTypeTableName + ".id",ondelete="set null", onupdate="set null"),nullable=True)
